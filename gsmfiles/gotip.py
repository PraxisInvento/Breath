...
#req = "/dibrugarh/vote.php?camera=1&device_number=5&latitude=1&longitude=1&speed=1&altitude=1"
APN = "airtelgprs.com"
req = "/index.php"
getdata = "/index.php?name=poda&age=456"
jsondata = {"name":"sam","age":1452}
HOST = "ec2-52-66-151-17.ap-south-1.compute.amazonaws.com"
PORT = 192
#HOST = "cleancitiesfoundation.com"
#PORT = 80
#SERIAL_PORT = "/dev/ttyUSB0"  # Raspberry Pi usb
...
while True:
	...
	#ser.write(msg)
	print(".")
	sendHTTPGETRequest(ser, HOST, getdata)
	#sendHTTPPOSTRequest(ser, HOST, req, jsondata)
	time.sleep(4)
	break
closeTCP(ser)
	#break
